    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-x-hidden">
        ...
        <motion.div
          ...
          className="relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl max-h-[90vh] flex flex-col overflow-hidden border border-slate-200"
        >
          {/* Header */}
                ...
                >
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-white border border-slate-200 rounded-xl text-[#1b1b1b] placeholder-slate-400 focus:outline-none focus:border-primary transition-colors"
                      autoFocus
                    />
          ...
          <div className="flex items-center justify-between p-3 sm:p-6 border-t border-slate-200 flex-shrink-0 gap-2">
            ...
            <button
              ...
              className="px-4 sm:px-6 py-2 sm:py-2.5 text-xs sm:text-sm bg-[#a855f7] hover:bg-[#5348c7] disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold rounded-lg sm:rounded-xl transition-colors flex-shrink-0"
            >
              {isSubmitting ? (
                <>
