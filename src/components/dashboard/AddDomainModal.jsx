        ...
        >
          ...
          <div className="flex items-center justify-between p-3 sm:p-6 border-t border-slate-200 flex-shrink-0 gap-2">
            ...
            <button
              ...
              className="px-4 sm:px-6 py-2 sm:py-2.5 text-xs sm:text-sm bg-[#6358de] hover:bg-[#5348c7] disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold rounded-lg sm:rounded-xl transition-colors flex-shrink-0"
            >
              {isSubmitting ? (
                <>
