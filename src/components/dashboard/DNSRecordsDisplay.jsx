...
const DNSRecordsDisplay = ({ records, domain }) => {
  ...
  const sslRecord = txtRecords.find(
    (r) =>
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="flex-shrink-0 pt-6">
                <CopyButton value={ownershipRecord.value} fieldName="ownership-value" />
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="flex-shrink-0 pt-6">
                <CopyButton value={sslHost || sslRecord.host} fieldName="ssl-host" />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="flex-shrink-0 pt-6">
                <CopyButton value={sslRecord.value} fieldName="ssl-value" />
              </div>
            </div>
          </div>
        </motion.div>
      ...
      {cnameRecord && (
        ...
        >
          <div>
            ...
            <p className="text-sm text-slate-400 mb-4">Connect your subdomain to our servers.</p>
          </div>
