...
const Hero = ({ user }) => {
  return (
    <section className="relative px-6 py-12 md:px-20 lg:py-24 overflow-hidden bg-[#00f59b]">
        ...
        <div className="flex flex-col gap-10 lg:flex-row items-center">
          ...
          >
            <div
              ...
              style={{
                backgroundImage:
                  'url("https://lh3.googleusercontent.com/aida-public/AB6AXuBoNfDCiWZcsItO-4obvc0B3RctHB51VHAk81kcYxmCzu4tHnj4izCgl27MwXdx2SO_Cv71ECszSAwKrm8RmIL_8P8UElStEyOQA16k2kmhOiyEHhHhDV-AoHikH0yTH2uSYyZlehHOHIB5S0yeGmz4slyaQZVW47nrrcDI_C3ZjGyKVE91_RV1SsWBoVBRcmGYfV8sAwzAsLsAubZthf2ELSOqB5iUyVJTJZCoCe20IcHEervV9_C0OB4Ymk8fGMVh3ku54y5Bt8o")',
              }}
            >
