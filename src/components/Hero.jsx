        ...
        <div className="flex flex-col gap-10 lg:flex-row items-center">
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
              ...
              <button className="flex h-12 min-w-[140px] cursor-pointer items-center justify-center rounded-lg bg-slate-200 dark:bg-[#584674] hover:bg-slate-300 dark:hover:bg-[#6b5a87] px-6 text-slate-900 dark:text-white text-base font-bold transition-all">
                View Demo
              </button>
            </div>
          ...
          >
            <div 
              className="w-full aspect-video bg-center bg-no-repeat bg-cover rounded-xl shadow-2xl shadow-primary/20 border border-slate-200 dark:border-[#584674] overflow-hidden relative group" 
            ...
            >
              ...
              <motion.div 
                ...
                className="absolute top-4 right-4 sm:top-10 sm:right-10 bg-white/10 dark:bg-[#192233]/90 backdrop-blur-md p-3 sm:p-4 rounded-lg border border-white/20 dark:border-[#6b5a87] shadow-xl w-32 sm:w-48"
              >
