  ...
  return (
    <section className="relative px-6 py-16 md:py-24 bg-[#d7fec8]">
      <div className="mx-auto max-w-7xl flex flex-col items-center text-center">
        ...
        >
          {/* Main line */}
          <h1 className="text-slate-900 text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black leading-loose md:leading-[1.75] lg:leading-[2] xl:leading-[2.25] tracking-tight">
