        ...
        <div className="flex flex-col gap-10 lg:flex-row items-center">
          ...
          >
            <div className="flex flex-col gap-4">
              <p className="text-slate-600 dark:text-[#1b1b1b] text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight">
                Shorten, Shield, Track
              </p>
              ...
              <h2 className="text-slate-700 dark:text-[#1b1b1b] text-xl font-bold leading-relaxed md:text-2xl max-w-2xl mx-auto lg:mx-0">
                One platform to manage your links, block bots, and send Conversion API & S2S tracking to Facebook, Google, TikTok and more.
              </h2>
            </div>
