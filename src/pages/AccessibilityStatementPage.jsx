        ...
        <article className="max-w-[900px] mx-auto bg-white rounded-2xl shadow-md border border-slate-100 p-8 md:p-10">
          ...
          <div className="bg-[#d7fec8] p-6 md:p-7 rounded-xl text-[#166534]">
            ...
            <ul className="list-disc pl-5 space-y-2 mb-0">
              ...
              <li>
                <b>Restoring the Widget:</b> To restore it, click the <b>&quot;Show accessibility menu&quot;</b>{' '}
                link in our website footer (also available in the dashboard footer and on the login page when the
                button is hidden).
              </li>
            </ul>
          </div>
